...
def CheckArgs(args):
    ...
    if not args.relu_dim is None:
        ...
        args.final_nonlin_output_dim = args.relu_dim_final
        args.nonlin_type = 'relu'
...
def MakeConfigs(config_dir, splice_indexes_string,
                ...
                final_nonlin_output_dim, nonlin_output_dim_init, nonlin_output_dim_final,
    ...
    for i in range(0, num_hidden_layers):
        ...
        if xent_separate_forward_affine and i == num_hidden_layers - 1:
            ...
            if i == num_hidden_layers - 1:
                ...
                local_nonlin_output_dim = nonlin_output_dims[i]
